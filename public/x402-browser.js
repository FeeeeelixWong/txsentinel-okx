...
`;
  ...
  var FeeConflictError, InvalidSerializableTransactionError, TransactionExecutionError, TransactionNotFoundError, TransactionReceiptNotFoundError, TransactionReceiptRevertedError, WaitForTransactionReceiptTimeoutError;
...
${prettyStateOverride(stateOverride)}`;
  ...
  // node_modules/@okxweb3/x402-core/dist/esm/chunk-O3IYMTNT.mjs
  var x402Version = 2;
  ...
  // node_modules/@okxweb3/x402-core/dist/esm/chunk-E363UOMT.mjs
  ...
  // node_modules/@okxweb3/x402-core/dist/esm/client/index.mjs
  ...
  // node_modules/@okxweb3/x402-fetch/dist/esm/index.mjs
  ...
  function custom2(provider2, config = {}) {
  ...
  // node_modules/@okxweb3/x402-evm/dist/esm/chunk-74QEGGFC.mjs
  ...
  // node_modules/@okxweb3/x402-evm/dist/esm/chunk-2K22OMTA.mjs
  ...
  // node_modules/@okxweb3/x402-evm/dist/esm/chunk-QSDGM24Y.mjs
  ...
  // node_modules/@okxweb3/x402-evm/dist/esm/chunk-2HIS7LN3.mjs
  ...
  // src/x402-browser.js
  var NETWORK = "eip155:1952";
  var CHAIN_ID = 1952;
  var CHAIN_HEX = "0x7a0";
  var RPC_URL = "https://testrpc.xlayer.tech/terigon";
  var EXPLORER_URL = "https://www.okx.com/web3/explorer/xlayer-test";
  ...
  function setStep(index2) {
    elements.steps.forEach((step, stepIndex) => {
      step?.classList.toggle("complete", stepIndex < index2);
      step?.classList.toggle("active", stepIndex === index2);
    });
  }
  ...
  function setBusy(button, busy, label) {
    ...
    if (label) (_a = button.dataset).idleLabel || (_a.idleLabel = button.textContent);
  ...
  async function connectWallet() {
    ...
    try {
      ...
      setStep(2);
      setMessage(
        hasFunds ? "Wallet is ready. The next button is the payment confirmation gate; OKX Wallet will ask for the EIP-3009 signature." : `Insufficient test-token balance. This payment requires ${tokenAmount(accepted)} ${accepted.extra?.name || "USD\u20AE0"}.`,
        hasFunds ? "" : "error"
      );
    } catch (error) {
